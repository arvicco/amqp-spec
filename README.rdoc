...
works normally otherwise. You can use default_timeout and default_options macros to avoid
manually setting AMQP options for each example. However, if you DO manually set options
